...
export default function Navbar() {
  ...
  return (
    <nav className="mt-5 py-4 px-6 flex md:justify-center w-full md:w-fit mx-auto bg-white/10 rounded-[50px] shadow-[inset_0_4px_20px_-12px_rgba(0,0,0,0.15),inset_0_-4px_20px_-12px_rgba(0,0,0,0.15)]">
