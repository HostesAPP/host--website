  ...
  return (
    <nav className="bg-transparent z-100 sticky top-0">
      <div className="px-4 md:px-8">
        <div className="nav-container mt-5 mx-auto z-100 flex w-full max-w-full py-4 px-6 md:w-fit md:justify-center bg-white rounded-[50px] shadow-[inset_0_4px_20px_-12px_rgba(0,0,0,0.15),inset_0_-4px_20px_-12px_rgba(0,0,0,0.15)]">
                ...
                <div className="nav-content flex flex-col gap-6">
                  {navlinks.map(({ id, name, href }) => (
                    <Link
                      ...
                      onClick={closeMenu}
                    >
                      <span className="text-[14px] dark:text-black">
                        {name}
                      </span>
                    </Link>
                  ))}
